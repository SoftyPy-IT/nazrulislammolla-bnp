...
export const CanvasEditor = memo<CanvasEditorProps>(function CanvasEditor({
  ...
  return (
    ...
    >
      <div
        className={`relative rounded overflow-hidden transition-all duration-300 ${isDragging
          ? "cursor-grabbing"
          : userImage
            ? "cursor-grab "
            : onImageUpload
      ...
      >
        ...
        {userImage && isReady && (
          <div
            className={`absolute bottom-3 sm:bottom-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-2 sm:px-5 py-2 sm:py-2.5 rounded-full text-[10px] sm:text-xs font-bold shadow-lg shadow-emerald-500/20 pointer-events-none transition-all duration-300 flex items-center gap-2 ${isDragging
